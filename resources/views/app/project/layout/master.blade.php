		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="page d-flex flex-row flex-column-fluid">
				...
				{{-- Sidebar --}}
				@include('project.layout.aside._base')
				

				<!--begin::Wrapper-->
				<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">

					@include('project.layout.header._base')

					<!--begin::Content-->
					<div class="content d-flex flex-column flex-column-fluid" id="kt_content">

						{{-- @include('project.layout.toolbars._toolbar-1') --}}
					...
					@include('project.layout._footer')
		...
		{{-- @include('project.layout.drawers._activity-drawer') --}}
