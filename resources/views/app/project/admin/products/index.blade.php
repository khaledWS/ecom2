    ...
    <div class="card card-flush">
        ...
        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
            ...
            <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                ...
                <!--begin::Add product-->
                <a href="/metronic8/demo1/../demo1/apps/ecommerce/catalog/add-product.html" class="btn btn-primary">Add
                    Product</a>
                <!--end::Add product-->
            </div>
            <!--end::Card toolbar-->
                ...
                <tbody class="fw-bold text-gray-600">
                    ...
                    <tr>
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <a href="/metronic8/demo1/../demo1/apps/ecommerce/catalog/edit-product.html"
                                    ...
                                    <span class="symbol-label"
                                        style="background-image:url({{asset('assets/media/stock/300x270/3.jpg')}});"></span>
                                ...
                                <div class="ms-5">
                                    ...
                                    <a href="/metronic8/demo1/../demo1/apps/ecommerce/catalog/edit-product.html"
                                        ...
                                        data-kt-ecommerce-product-filter="product_name">khaled</a>
                                    <!--end::Title-->
                                </div>
                            </div>
                        </td>
                        ...
                        <td class="text-end pe-0">
                            <span class="fw-bolder">03239006</span>
                        </td>
                        <!--end::SKU=-->
                        <!--begin::Qty=-->
                        ...
                        <!--begin::Price=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder text-dark">$104.00</span>
                        </td>
                        <!--end::Price=-->
                        <!--begin::Rating-->
                    ...
                    <tr>
                        ...
                        <!--begin::SKU=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder">02806003</span>
                        </td>
                        <!--end::SKU=-->
                        <!--begin::Qty=-->
                    ...
                    <tr>
                        ...
                        <!--begin::SKU=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder">04130005</span>
                        </td>
                        <!--end::SKU=-->
                        <!--begin::Qty=-->
                    ...
                    <tr>
                        ...
                        <!--begin::SKU=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder">04747002</span>
                        </td>
                        <!--end::SKU=-->
                        <!--begin::Qty=-->
                        <td class="text-end pe-0" data-order="25">
                    ...
                    <tr>
                        ...
                        <!--begin::SKU=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder">02678006</span>
                        </td>
                        <!--end::SKU=-->
                        <!--begin::Qty=-->
                        <td class="text-end pe-0" data-order="16">
                            <span class="fw-bolder ms-3">16</span>
                        </td>
                        <!--end::Qty=-->
                        <!--begin::Price=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder text-dark">$176.00</span>
                        </td>
                        <!--end::Price=-->
                        <!--begin::Rating-->
                        <td class="text-end pe-0" data-order="rating-5">
                    ...
                    <tr>
                        ...
                        <!--begin::SKU=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder">04569008</span>
                        </td>
                        <!--end::SKU=-->
                        <!--begin::Qty=-->
                    ...
                    <tr>
                        ...
                        <!--begin::SKU=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder">03794003</span>
                        </td>
                        <!--end::SKU=-->
                        <!--begin::Qty=-->
                        ...
                        <!--begin::Price=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder text-dark">$161.00</span>
                        </td>
                        <!--end::Price=-->
                        <!--begin::Rating-->
                        <td class="text-end pe-0" data-order="rating-5">
                    ...
                    <tr>
                        ...
                        <!--begin::SKU=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder">01365006</span>
                        </td>
                        <!--end::SKU=-->
                        <!--begin::Qty=-->
                    ...
                    <tr>
                        ...
                        <!--begin::SKU=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder">04934002</span>
                        </td>
                        <!--end::SKU=-->
                        <!--begin::Qty=-->
                        <td class="text-end pe-0" data-order="31">
                    ...
                    <tr>
                        ...
                        <!--begin::SKU=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder">01119006</span>
                        </td>
                        <!--end::SKU=-->
                        <!--begin::Qty=-->
                    ...
                    <tr>
                        ...
                        <!--begin::SKU=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder">02477002</span>
                        </td>
                        <!--end::SKU=-->
                        <!--begin::Qty=-->
                    ...
                    <tr>
                        ...
                        <!--begin::SKU=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder">01320009</span>
                        </td>
                        <!--end::SKU=-->
                        <!--begin::Qty=-->
                    ...
                    <tr>
                        ...
                        <!--begin::SKU=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder">03322001</span>
                        </td>
                        <!--end::SKU=-->
                        <!--begin::Qty=-->
                        <td class="text-end pe-0" data-order="16">
                    ...
                    <tr>
                        ...
                        <!--begin::SKU=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder">02629006</span>
                        </td>
                        <!--end::SKU=-->
                        <!--begin::Qty=-->
                    ...
                    <tr>
                        ...
                        <!--begin::SKU=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder">04845004</span>
                        </td>
                        <!--end::SKU=-->
                        <!--begin::Qty=-->
                        <td class="text-end pe-0" data-order="23">
                    ...
                    <tr>
                        ...
                        <!--begin::SKU=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder">01256003</span>
                        </td>
                        <!--end::SKU=-->
                        <!--begin::Qty=-->
                    ...
                    <tr>
                        ...
                        <!--begin::SKU=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder">04166001</span>
                        </td>
                        <!--end::SKU=-->
                        <!--begin::Qty=-->
                        ...
                        <!--begin::Price=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder text-dark">$157.00</span>
                        </td>
                        <!--end::Price=-->
                        <!--begin::Rating-->
                        <td class="text-end pe-0" data-order="rating-5">
                    ...
                    <tr>
                        ...
                        <!--begin::SKU=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder">04514002</span>
                        </td>
                        <!--end::SKU=-->
                        <!--begin::Qty=-->
                    ...
                    <tr>
                        ...
                        <!--begin::SKU=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder">02867006</span>
                        </td>
                        <!--end::SKU=-->
                        <!--begin::Qty=-->
                        <td class="text-end pe-0" data-order="36">
                    ...
                    <tr>
                        ...
                        <!--begin::SKU=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder">02900004</span>
                        </td>
                        <!--end::SKU=-->
                        <!--begin::Qty=-->
                        <td class="text-end pe-0" data-order="9">
                        ...
                        <!--begin::Price=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder text-dark">$228.00</span>
                        </td>
                        <!--end::Price=-->
                        <!--begin::Rating-->
                        <td class="text-end pe-0" data-order="rating-4">
                    ...
                    <tr>
                        ...
                        <!--begin::SKU=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder">04201005</span>
                        </td>
                        <!--end::SKU=-->
                        <!--begin::Qty=-->
                        ...
                        <!--begin::Price=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder text-dark">$164.00</span>
                        </td>
                        <!--end::Price=-->
                        <!--begin::Rating-->
                        <td class="text-end pe-0" data-order="rating-3">
                    ...
                    <tr>
                        ...
                        <!--begin::SKU=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder">01577005</span>
                        </td>
                        <!--end::SKU=-->
                        <!--begin::Qty=-->
                    ...
                    <tr>
                        ...
                        <!--begin::SKU=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder">04363006</span>
                        </td>
                        <!--end::SKU=-->
                        <!--begin::Qty=-->
                        <td class="text-end pe-0" data-order="42">
                    ...
                    <tr>
                        ...
                        <!--begin::SKU=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder">03879008</span>
                        </td>
                        <!--end::SKU=-->
                        <!--begin::Qty=-->
                    ...
                    <tr>
                        ...
                        <!--begin::SKU=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder">02110009</span>
                        </td>
                        <!--end::SKU=-->
                        <!--begin::Qty=-->
                        ...
                        <!--begin::Price=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder text-dark">$136.00</span>
                        </td>
                        <!--end::Price=-->
                        <!--begin::Rating-->
                        <td class="text-end pe-0" data-order="rating-5">
                    ...
                    <tr>
                        ...
                        <!--begin::SKU=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder">02439002</span>
                        </td>
                        <!--end::SKU=-->
                        <!--begin::Qty=-->
                        ...
                        <!--begin::Price=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder text-dark">$296.00</span>
                        </td>
                        <!--end::Price=-->
                        <!--begin::Rating-->
                        <td class="text-end pe-0" data-order="rating-3">
                    ...
                    <tr>
                        ...
                        <!--begin::SKU=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder">04892002</span>
                        </td>
                        <!--end::SKU=-->
                        <!--begin::Qty=-->
                        <td class="text-end pe-0" data-order="36">
                        ...
                        <!--begin::Price=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder text-dark">$259.00</span>
                        </td>
                        <!--end::Price=-->
                        <!--begin::Rating-->
                        <td class="text-end pe-0" data-order="rating-3">
                    ...
                    <tr>
                        ...
                        <!--begin::SKU=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder">02694008</span>
                        </td>
                        <!--end::SKU=-->
                        <!--begin::Qty=-->
                    ...
                    <tr>
                        ...
                        <!--begin::SKU=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder">03745003</span>
                        </td>
                        <!--end::SKU=-->
                        <!--begin::Qty=-->
                        ...
                        <!--begin::Price=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder text-dark">$48.00</span>
                        </td>
                        <!--end::Price=-->
                        <!--begin::Rating-->
                        <td class="text-end pe-0" data-order="rating-4">
                    ...
                    <tr>
                        ...
                        <!--begin::SKU=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder">04101002</span>
                        </td>
                        <!--end::SKU=-->
                        <!--begin::Qty=-->
                        <td class="text-end pe-0" data-order="6">
                    ...
                    <tr>
                        ...
                        <!--begin::SKU=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder">04303001</span>
                        </td>
                        <!--end::SKU=-->
                        <!--begin::Qty=-->
                        <td class="text-end pe-0" data-order="18">
                    ...
                    <tr>
                        ...
                        <!--begin::SKU=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder">03294002</span>
                        </td>
                        <!--end::SKU=-->
                        <!--begin::Qty=-->
                    ...
                    <tr>
                        ...
                        <!--begin::SKU=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder">03400008</span>
                        </td>
                        <!--end::SKU=-->
                        <!--begin::Qty=-->
                        <td class="text-end pe-0" data-order="9">
                        ...
                        <!--begin::Price=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder text-dark">$248.00</span>
                        </td>
                        <!--end::Price=-->
                        <!--begin::Rating-->
                        <td class="text-end pe-0" data-order="rating-5">
                    ...
                    <tr>
                        ...
                        <!--begin::SKU=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder">04147005</span>
                        </td>
                        <!--end::SKU=-->
                        <!--begin::Qty=-->
                        ...
                        <!--begin::Price=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder text-dark">$111.00</span>
                        </td>
                        <!--end::Price=-->
                        <!--begin::Rating-->
                        <td class="text-end pe-0" data-order="rating-4">
                    ...
                    <tr>
                        ...
                        <!--begin::SKU=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder">02197003</span>
                        </td>
                        <!--end::SKU=-->
                        <!--begin::Qty=-->
                        <td class="text-end pe-0" data-order="6">
                    ...
                    <tr>
                        ...
                        <!--begin::SKU=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder">04924005</span>
                        </td>
                        <!--end::SKU=-->
                        <!--begin::Qty=-->
                        <td class="text-end pe-0" data-order="30">
                    ...
                    <tr>
                        ...
                        <!--begin::SKU=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder">04423005</span>
                        </td>
                        <!--end::SKU=-->
                        <!--begin::Qty=-->
                    ...
                    <tr>
                        ...
                        <!--begin::SKU=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder">03474005</span>
                        </td>
                        <!--end::SKU=-->
                        <!--begin::Qty=-->
                        <td class="text-end pe-0" data-order="35">
                    ...
                    <tr>
                        ...
                        <!--begin::SKU=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder">02323004</span>
                        </td>
                        <!--end::SKU=-->
                        <!--begin::Qty=-->
                    ...
                    <tr>
                        ...
                        <!--begin::SKU=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder">02127008</span>
                        </td>
                        <!--end::SKU=-->
                        <!--begin::Qty=-->
                        ...
                        <!--begin::Price=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder text-dark">$109.00</span>
                        </td>
                        <!--end::Price=-->
                        <!--begin::Rating-->
                        <td class="text-end pe-0" data-order="rating-5">
                    ...
                    <tr>
                        ...
                        <!--begin::SKU=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder">03897001</span>
                        </td>
                        <!--end::SKU=-->
                        <!--begin::Qty=-->
                        <td class="text-end pe-0" data-order="18">
                        ...
                        <!--begin::Price=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder text-dark">$45.00</span>
                        </td>
                        <!--end::Price=-->
                        <!--begin::Rating-->
                        <td class="text-end pe-0" data-order="rating-4">
                    ...
                    <tr>
                        ...
                        <!--begin::SKU=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder">04451004</span>
                        </td>
                        <!--end::SKU=-->
                        <!--begin::Qty=-->
                        ...
                        <!--begin::Price=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder text-dark">$260.00</span>
                        </td>
                        <!--end::Price=-->
                        <!--begin::Rating-->
                        <td class="text-end pe-0" data-order="rating-4">
                    ...
                    <tr>
                        ...
                        <!--begin::SKU=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder">03780005</span>
                        </td>
                        <!--end::SKU=-->
                        <!--begin::Qty=-->
                        <td class="text-end pe-0" data-order="42">
                    ...
                    <tr>
                        ...
                        <!--begin::SKU=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder">02823005</span>
                        </td>
                        <!--end::SKU=-->
                        <!--begin::Qty=-->
                        <td class="text-end pe-0" data-order="42">
                    ...
                    <tr>
                        ...
                        <!--begin::SKU=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder">03271005</span>
                        </td>
                        <!--end::SKU=-->
                        <!--begin::Qty=-->
                    ...
                    <tr>
                        ...
                        <!--begin::SKU=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder">02346009</span>
                        </td>
                        <!--end::SKU=-->
                        <!--begin::Qty=-->
                        <td class="text-end pe-0" data-order="1">
                        ...
                        <!--begin::Price=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder text-dark">$131.00</span>
                        </td>
                        <!--end::Price=-->
                        <!--begin::Rating-->
                        <td class="text-end pe-0" data-order="rating-4">
                    ...
                    <tr>
                        ...
                        <!--begin::SKU=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder">02596006</span>
                        </td>
                        <!--end::SKU=-->
                        <!--begin::Qty=-->
                        ...
                        <!--begin::Price=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder text-dark">$78.00</span>
                        </td>
                        <!--end::Price=-->
                        <!--begin::Rating-->
                        <td class="text-end pe-0" data-order="rating-4">
                    ...
                    <tr>
                        ...
                        <!--begin::SKU=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder">04139005</span>
                        </td>
                        <!--end::SKU=-->
                        <!--begin::Qty=-->
                        ...
                        <!--begin::Price=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder text-dark">$100.00</span>
                        </td>
                        <!--end::Price=-->
                        <!--begin::Rating-->
                        <td class="text-end pe-0" data-order="rating-5">
                    ...
                    <tr>
                        ...
                        <!--begin::SKU=-->
                        <td class="text-end pe-0">
                            <span class="fw-bolder">03973005</span>
                        </td>
                        <!--end::SKU=-->
                        <!--begin::Qty=-->
                        <td class="text-end pe-0" data-order="19">
